...
/*
 * @brief	Lee informacion relacionada al fincionamiento del chip.
 * @note	Hasta el momento solo se implemento la cantidad de resest, se puede agregar temperatura,
 * 			alarmas tamper, etc.
 * @param 	Ninguno.
 * @retval 	Informacion del chip.
 */
 ...
 * @addresss:	posicion de memoria, desde 0 hasta tamño_de_memoria - 1.
 * @data:
 * @param data_length
...
uint32_t FM_FLASH_Write(uint32_t memory_address, uint8_t *data, uint16_t data_length)
{
	...
	// Para metodo de borrado se elige borrar paginas.
