...
#define LL_RCC_MSI_GetRangeAfterStandby   LL_RCC_MSIS_GetRangeAfterStandby  /*!< alias define for compatibility with legacy code */
    ...
    __STATIC_INLINE void LL_RCC_MSI_SetCalibTrimming(uint32_t Value, uint32_t Oscillator)
    {
        MODIFY_REG(RCC->ICSCR2, (RCC_ICSCR2_MSITRIM0 >> Oscillator),
                Value << (RCC_ICSCR2_MSITRIM0_Pos - Oscillator));
    }
    ...
    __STATIC_INLINE uint32_t LL_RCC_MSI_GetCalibTrimming(uint32_t Oscillator)
    {
        return (uint32_t) (READ_BIT(RCC->ICSCR2, (RCC_ICSCR2_MSITRIM0 >> Oscillator))
                >> (RCC_ICSCR2_MSITRIM0_Pos - Oscillator));
    }
    ...
    __STATIC_INLINE uint32_t LL_RCC_MSI_GetCalibration(uint32_t Oscillator)
    {
        return (uint32_t) (READ_BIT(RCC->ICSCR1, (RCC_ICSCR1_MSICAL0 >> Oscillator))
                >> (RCC_ICSCR1_MSICAL0_Pos - Oscillator));
    }
    ...
    __STATIC_INLINE void LL_RCC_SetUSARTClockSource(uint32_t USARTxSource)
    {
        ...
        MODIFY_REG(*reg, 3UL << ((USARTxSource & 0x001F0000U) >> 16U),
                ((USARTxSource & 0x000000FFU) << ((USARTxSource & 0x001F0000U) >> 16U)));
    }
    ...
    __STATIC_INLINE void LL_RCC_SetI2CClockSource(uint32_t I2CxSource)
    {
        ...
        MODIFY_REG(*reg, 3UL << (((I2CxSource & 0x00FF0000U) >> 16U) & 0x1FU),
                ((I2CxSource & 0x000000FFU) << (((I2CxSource & 0x00FF0000U) >> 16U) & 0x1FU)));
    }
    ...
    __STATIC_INLINE void LL_RCC_SetSPIClockSource(uint32_t SPIxSource)
    {
        ...
        MODIFY_REG(*reg, 3UL << (((SPIxSource & 0x00FF0000U) >> 16U) & 0x1FU),
                ((SPIxSource & 0x000000FFU) << (((SPIxSource & 0x00FF0000U) >> 16U) & 0x1FU)));
    }
    ...
    __STATIC_INLINE void LL_RCC_SetLPTIMClockSource(uint32_t LPTIMxSource)
    {
        ...
        MODIFY_REG(*reg, 3UL << (((LPTIMxSource & 0x00FF0000U) >> 16U) & 0x1FU),
                ((LPTIMxSource & 0x000000FFU) << (((LPTIMxSource & 0x00FF0000U) >> 16U) & 0x1FU)));
    }
...
#define LL_RCC_PLL_IsReady     LL_RCC_PLL1_IsReady    /*!< alias for compatibility with legacy code */
     ...
     * @retval None
     */
    __STATIC_INLINE void LL_RCC_PLL1_ConfigDomain_SYS(uint32_t Source, uint32_t PLLM, uint32_t PLLN,
            uint32_t PLLR)
    {
        MODIFY_REG(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1SRC | RCC_PLL1CFGR_PLL1M,
                Source | ((PLLM - 1UL) << RCC_PLL1CFGR_PLL1M_Pos));
...
#define LL_RCC_PLL_ConfigDomain_SYS     LL_RCC_PLL1_ConfigDomain_SYS    /*!< alias for compatibility with legacy code */
     ...
     * @retval None
     */
    __STATIC_INLINE void LL_RCC_PLL1_ConfigDomain_SAI(uint32_t Source, uint32_t PLLM, uint32_t PLLN,
            uint32_t PLLP)
    {
        MODIFY_REG(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1SRC | RCC_PLL1CFGR_PLL1M,
                Source | ((PLLM - 1UL) << RCC_PLL1CFGR_PLL1M_Pos));
...
#define LL_RCC_PLL_ConfigDomain_SAI     LL_RCC_PLL1_ConfigDomain_SAI    /*!< alias for compatibility with legacy code */
     ...
     * @retval None
     */
    __STATIC_INLINE void LL_RCC_PLL1_ConfigDomain_48M(uint32_t Source, uint32_t PLLM, uint32_t PLLN,
            uint32_t PLLQ)
    {
        MODIFY_REG(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1SRC | RCC_PLL1CFGR_PLL1M,
                Source | ((PLLM - 1UL) << RCC_PLL1CFGR_PLL1M_Pos));
...
#define LL_RCC_PLL_SetN     LL_RCC_PLL1_SetN    /*!< alias for compatibility with legacy code */
    ...
    {
        return (uint32_t) ((READ_BIT(RCC->PLL1DIVR, RCC_PLL1DIVR_PLL1N) >> RCC_PLL1DIVR_PLL1N_Pos)
                + 1UL);
    }
...
#define LL_RCC_PLL_SetP     LL_RCC_PLL1_SetP    /*!< alias for compatibility with legacy code */
    ...
    {
        return (uint32_t) ((READ_BIT(RCC->PLL1DIVR, RCC_PLL1DIVR_PLL1P) >> RCC_PLL1DIVR_PLL1P_Pos)
                + 1UL);
    }
...
#define LL_RCC_PLL_SetQ     LL_RCC_PLL1_SetQ    /*!< alias for compatibility with legacy code */
    ...
    {
        return (uint32_t) ((READ_BIT(RCC->PLL1DIVR, RCC_PLL1DIVR_PLL1Q) >> RCC_PLL1DIVR_PLL1Q_Pos)
                + 1UL);
    }
...
#define LL_RCC_PLL_SetR     LL_RCC_PLL1_SetR    /*!< alias for compatibility with legacy code */
    ...
    {
        return (uint32_t) ((READ_BIT(RCC->PLL1DIVR, RCC_PLL1DIVR_PLL1R) >> RCC_PLL1DIVR_PLL1R_Pos)
                + 1UL);
    }
...
#define LL_RCC_PLL_DisableDomain_SAI     LL_RCC_PLL1_DisableDomain_SAI    /*!< alias for compatibility with legacy code */
    ...
    {
        return ((READ_BIT(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1PEN) == (RCC_PLL1CFGR_PLL1PEN)) ?
                1UL : 0UL);
    }
...
#define LL_RCC_PLL_DisableDomain_48M     LL_RCC_PLL1_DisableDomain_48M    /*!< alias for compatibility with legacy code */
    ...
    {
        return ((READ_BIT(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1QEN) == (RCC_PLL1CFGR_PLL1QEN)) ?
                1UL : 0UL);
    }
...
#define LL_RCC_PLL_DisableDomain_SYS     LL_RCC_PLL1_DisableDomain_SYS    /*!< alias for compatibility with legacy code */
    ...
    {
        return ((READ_BIT(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1REN) == (RCC_PLL1CFGR_PLL1REN)) ?
                1UL : 0UL);
    }
...
#define LL_RCC_PLLFRACN_Enable     LL_RCC_PLL1FRACN_Enable    /*!< alias for compatibility with legacy code */
    ...
    {
        return ((READ_BIT(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1FRACEN) == RCC_PLL1CFGR_PLL1FRACEN) ?
                1UL : 0UL);
    }
...
#define LL_RCC_PLL_SetVCOInputRange     LL_RCC_PLL1_SetVCOInputRange    /*!< alias for compatibility with legacy code */
     ...
     * @retval None
     */
    __STATIC_INLINE void LL_RCC_PLL2_ConfigDomain_48M(uint32_t Source, uint32_t PLLM, uint32_t PLLN,
            uint32_t PLLQ)
    {
        MODIFY_REG(RCC->PLL2CFGR, RCC_PLL2CFGR_PLL2SRC | RCC_PLL2CFGR_PLL2M,
                Source | ((PLLM - 1UL) << RCC_PLL2CFGR_PLL2M_Pos));
     ...
     * @retval None
     */
    __STATIC_INLINE void LL_RCC_PLL2_ConfigDomain_SAI(uint32_t Source, uint32_t PLLM, uint32_t PLLN,
            uint32_t PLLP)
    {
        MODIFY_REG(RCC->PLL2CFGR, RCC_PLL2CFGR_PLL2SRC | RCC_PLL2CFGR_PLL2M,
                Source | ((PLLM - 1UL) << RCC_PLL2CFGR_PLL2M_Pos));
     ...
     * @retval None
     */
    __STATIC_INLINE void LL_RCC_PLL2_ConfigDomain_ADC(uint32_t Source, uint32_t PLLM, uint32_t PLLN,
            uint32_t PLLR)
    {
        MODIFY_REG(RCC->PLL2CFGR, RCC_PLL2CFGR_PLL2SRC | RCC_PLL2CFGR_PLL2M,
                Source | ((PLLM - 1UL) << RCC_PLL2CFGR_PLL2M_Pos));
    ...
    {
        return (uint32_t) ((READ_BIT(RCC->PLL2DIVR, RCC_PLL2DIVR_PLL2N) >> RCC_PLL2DIVR_PLL2N_Pos)
                + 1UL);
    }
    ...
    {
        return (uint32_t) ((READ_BIT(RCC->PLL2DIVR, RCC_PLL2DIVR_PLL2P) >> RCC_PLL2DIVR_PLL2P_Pos)
                + 1UL);
    }
    ...
    {
        return (uint32_t) ((READ_BIT(RCC->PLL2DIVR, RCC_PLL2DIVR_PLL2Q) >> RCC_PLL2DIVR_PLL2Q_Pos)
                + 1UL);
    }
    ...
    {
        return ((READ_BIT(RCC->PLL2CFGR, RCC_PLL2CFGR_PLL2PEN) == (RCC_PLL2CFGR_PLL2PEN)) ?
                1UL : 0UL);
    }
    ...
    {
        return ((READ_BIT(RCC->PLL2CFGR, RCC_PLL2CFGR_PLL2QEN) == (RCC_PLL2CFGR_PLL2QEN)) ?
                1UL : 0UL);
    }
    ...
    {
        return ((READ_BIT(RCC->PLL2CFGR, RCC_PLL2CFGR_PLL2REN) == (RCC_PLL2CFGR_PLL2REN)) ?
                1UL : 0UL);
    }
    ...
    {
        return ((READ_BIT(RCC->PLL2CFGR, RCC_PLL2CFGR_PLL2FRACEN) == RCC_PLL2CFGR_PLL2FRACEN) ?
                1UL : 0UL);
    }
     ...
     * @retval None
     */
    __STATIC_INLINE void LL_RCC_PLL3_ConfigDomain_SAI(uint32_t Source, uint32_t PLLM, uint32_t PLLN,
            uint32_t PLLP)
    {
        MODIFY_REG(RCC->PLL3CFGR, RCC_PLL3CFGR_PLL3SRC | RCC_PLL3CFGR_PLL3M,
                Source | ((PLLM - 1UL) << RCC_PLL3CFGR_PLL3M_Pos));
     ...
     * @retval None
     */
    __STATIC_INLINE void LL_RCC_PLL3_ConfigDomain_48M(uint32_t Source, uint32_t PLLM, uint32_t PLLN,
            uint32_t PLLQ)
    {
        MODIFY_REG(RCC->PLL3CFGR, RCC_PLL3CFGR_PLL3SRC | RCC_PLL3CFGR_PLL3M,
                Source | ((PLLM - 1UL) << RCC_PLL3CFGR_PLL3M_Pos));
    ...
    {
        return (uint32_t) ((READ_BIT(RCC->PLL3DIVR, RCC_PLL3DIVR_PLL3N) >> RCC_PLL3DIVR_PLL3N_Pos)
                + 1UL);
    }
    ...
    {
        return (uint32_t) ((READ_BIT(RCC->PLL3DIVR, RCC_PLL3DIVR_PLL3P) >> RCC_PLL3DIVR_PLL3P_Pos)
                + 1UL);
    }
    ...
    {
        return (uint32_t) ((READ_BIT(RCC->PLL3DIVR, RCC_PLL3DIVR_PLL3Q) >> RCC_PLL3DIVR_PLL3Q_Pos)
                + 1UL);
    }
    ...
    {
        return (uint32_t) ((READ_BIT(RCC->PLL3DIVR, RCC_PLL3DIVR_PLL3R) >> RCC_PLL3DIVR_PLL3R_Pos)
                + 1UL);
    }
    ...
    {
        return ((READ_BIT(RCC->PLL3CFGR, RCC_PLL3CFGR_PLL3PEN) == (RCC_PLL3CFGR_PLL3PEN)) ?
                1UL : 0UL);
    }
    ...
    {
        return ((READ_BIT(RCC->PLL3CFGR, RCC_PLL3CFGR_PLL3QEN) == (RCC_PLL3CFGR_PLL3QEN)) ?
                1UL : 0UL);
    }
    ...
    {
        return ((READ_BIT(RCC->PLL3CFGR, RCC_PLL3CFGR_PLL3FRACEN) == RCC_PLL3CFGR_PLL3FRACEN) ?
                1UL : 0UL);
    }
